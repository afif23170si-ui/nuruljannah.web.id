...
// Default prayer times (can be fetched from API in the future)
...
export function PrayerTimesWidget({ location = "Indonesia" }: PrayerTimesWidgetProps) {
  ...
  const calculatePrayerStates = useCallback(() => {
    ...
    const prayers: PrayerInfo[] = defaultPrayerTimes.map((p) => ({
      ...p,
      timeInMinutes: parseTimeToMinutes(p.time),
    }));

    // Find current prayer (most recent passed prayer)
    let current = prayers[prayers.length - 1]; // Default to Isya
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8">
          ...
          <div className="flex items-center gap-5 w-full lg:w-auto justify-between lg:justify-start">
             ...
             <div className="hidden lg:flex flex-col items-start gap-0.5">
                ...
                <span className="text-lg font-medium text-emerald-950 tracking-tight">
                  {location}
                </span>
             </div>
             ...
             <div className="flex flex-col items-end lg:hidden">
                ...
                <span className="text-[10px] text-emerald-800/60 mt-1">
                 ...
                 return (
                   ...
                   >
                      ...
                      <span className={cn(
                         ...
                         isNext ? "text-white" : "text-emerald-950"
                      )}>
                        {prayer.time}
                      </span>
                   </div>
